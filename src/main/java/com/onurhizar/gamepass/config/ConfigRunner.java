...
public class ConfigRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        ContractRecord contractRecord2 = createContractRecord("aa59d163-5e7e-4290-b6ac-b901b0b4543a",
                "33b455da-335a-4dc1-b4f1-b526c1c9ab4e"); // contract record of test@mail
